# 08 — Troubleshooting, Service Record & Alphabetical Index
...
- [Troubleshooting](#troubleshooting)
  ...
  - [Hydraulic](#troubleshooting--hydraulic)
  - [Brakes](#troubleshooting--brakes)
...
| **Engine not running in proper way** | Fuel filter choke | Replace filters |
| | Low quality of oil | Drain diesel from tank and fill clean diesel |
| | Choking of fuel system | Check fuel system |
| | Fuel injectors faulty | Replace fuel injector |
| **More oil consumption** | Oil level is more than maximum level | Keep oil level up to mark |
| | Oil quality is not good | Use genuine oil |
...
| **Engine not giving maximum power** | Fuel filter choke | Replace filter |
...
| **Engine abnormal noise** | Oil level less | Top up |
| | Oil pressure less | Check through authorized dealer |
| | Engine is overheated | Check and find reason |
| | Improper tappet setting | Adjust through authorized dealer |
| **Oil pressure indicator shows warning** | Oil level is less | Top up oil up to level |
| | Oil quality is not good | Use genuine engine oil |
| | Choking of oil system | Check and repair through authorized dealer |
| **Engine Over Heating** | Radiator cap faulty | Replace with new one |
...
| | Slippage of fan belt | Check belt tension |
...
| | Implement setting improper | Adjust it and take instrument from dealer for right |
| | Less engine temp | Check injections and service |
...
| Problem | Possible Cause | Remedy |
|---|---|---|
| **Excessive Heating of Oil** | Improper inflation pressure | Check and adjust according to specified |
| | Oil level is high or less | Check and maintain proper level |
| | Hydraulic Strainer choked | Clean/Replace |
| | Mechanical linkage may faulty | Contact your authorized dealer |
| **Linkage Goes Down Slowly** | Bush tight | Contact your authorized dealer |
| | Response valve setting improper | Contact your authorized dealer |
| **Linkage Not Lift Fully** | Improper lift arm setting | Contact your authorized dealer |
| | Improper internal adjustment | Contact your authorized dealer |
| **TPL Not Respond To Lifting While Operating Hydraulic Lever** | Linkage connection not joint properly | Contact your authorized dealer |
| | Heavy load on linkage | Contact your authorized dealer |
| **Hydraulic System Not Working Properly** | Response valve setting very low | Check valve by your dealer |
| | Oil level low | Check oil top up |
| | Hydraulic Strainer choked | Clean/Replace |
| | Hydraulic system faulty | Check through authorized dealer |
| | Hydraulic pump not working | Contact your authorized dealer |

### Troubleshooting — Brakes

| Problem | Possible Cause | Remedy |
|---|---|---|
| **Noise While Applying Brakes** | Wrong adjustment of brakes | Check |
| **Brakes Tractor Goes in One Side** | Both brakes are not set properly | Adjust |
| **Brakes Works When Fully Pressed** | Wrong adjustment of brake pedal | Check and Adjust. |

### Troubleshooting — Electrical

| Problem | Possible Cause | Remedy |
|---|---|---|
| **Electrical System Not Working** | Battery terminal loose or rusting of terminal | Clean and tight the terminals |
| | Less specific gravity | Replace or fill electrolyte up to level |
| **Starter Motor Not Working.** | Battery terminal loose / Battery discharged | Tightened / Recharge or replace battery |
| | Faulty starter motor | For repair contact your dealer |
| **Battery Not Charging** | Loose or rusted terminals | Top up |
| | Belt loose | Check belt tension |
...
| Field | Purpose |
|---|---|
| **CH. NO.** | Chassis (Chassis/Frame Serial) Number of the tractor |
| **ENGINE NO.** | Engine Serial Number |

**Service-entry table columns** (one row per service visit; the form provides approximately 17 blank rows):

| Column | Meaning / What to enter |
|---|---|
| **S. NO.** | Serial number of the service entry (sequential count of visits) |
| **DATE/ HOURS** | Date of service and/or tractor hour-meter reading at time of service |
| **DEALER CODE** | Code identifying the servicing dealer |
| **BRIEF JOB DESCRIPTION** | Short description of the service/maintenance job carried out |
| **ACTION TAKEN** | Details of the corrective action / work performed |
| **DEALER SIGN** | Signature of the authorised dealer who performed the service |

> **NOTE:** Maintain this Service Record up to date for warranty validation and resale history. Have the servicing dealer sign each completed entry.
